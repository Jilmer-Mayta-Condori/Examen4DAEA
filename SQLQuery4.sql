...
GO
INSERT [dbo].[Autor] ([IdAutor], [Nombre], [Nacionalidad]) VALUES (1, N'Cesar Vallejo', N'Peru')
GO
SET IDENTITY_INSERT [dbo].[Autor] OFF
GO
SET IDENTITY_INSERT [dbo].[Libro] ON 
GO
INSERT [dbo].[Libro] ([IdLibro], [IdAutor], [Codigo], [Titulo], [ISBN], [Editorial], [Numpags]) VALUES (1, 1, 150021, N'Los heraldos negros', N'KDEFWKAAS', N'Santillana', 50)
GO
SET IDENTITY_INSERT [dbo].[Libro] OFF
GO
SET IDENTITY_INSERT [dbo].[Prestamos] ON 
GO
INSERT [dbo].[Prestamos] ([IdPrestammo], [IdLibro], [IdUsuario], [FecPrestamo], [FecDevolucion]) VALUES (2, 1, 1, CAST(N'2020-06-18T10:34:09.000' AS DateTime), CAST(N'2020-08-18T10:34:09.000' AS DateTime))
GO
SET IDENTITY_INSERT [dbo].[Prestamos] OFF
GO
SET IDENTITY_INSERT [dbo].[Usuario] ON 
GO
INSERT [dbo].[Usuario] ([IdUsuario], [NumUsuario], [NIF], [Nombre], [Direccion], [Telefono]) VALUES (1, 1, N'NIF1', N'Jose Carlos', N'Av. Mariscal Castilla 231', N'989846262')
GO
